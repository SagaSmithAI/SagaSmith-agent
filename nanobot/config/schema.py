...
class AgentDefaults(Base):
    ...
    external_skills_dirs: list[str] = Field(
        default_factory=list,
        validation_alias=AliasChoices("externalSkillsDirs", "external_skills_dirs"),
        serialization_alias="externalSkillsDirs",
    )  # Additional read-only skill roots loaded by the main agent and subagents
